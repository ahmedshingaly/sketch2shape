...
def lua_recursive_model(module, seq):
    for m in module.modules:
        ...
        if name == 'SpatialConvolution' or name == 'nn.SpatialConvolutionMM':
            ...
            n = nn.ConvTranspose3d(m.nInputPlane, m.nOutputPlane, (m.kT, m.kW, m.kH), (m.dT, m.dW, m.dH),
                                   (m.padT, m.padW, m.padH), (m.adjT, m.adjW, m.adjH), 1)
            copy_param(m, n)
            add_submodule(seq, n)
    ...
    for m in module.modules:
        ...
        if name == 'SpatialConvolution' or name == 'nn.SpatialConvolutionMM':
            ...
            s += ['nn.ConvTranspose3d({},{},{},{},{},{},{})'.format(m.nInputPlane,
                                                                    m.nOutputPlane, (m.kT, m.kW, m.kH),
                                                                    (m.dT, m.dW, m.dH), (m.padT, m.padW, m.padH),
                                                                    (m.adjT, m.adjW, m.adjH), 1)]
        elif name == 'SpatialReplicationPadding':
...
def torch_to_pytorch(legacymodel=None, t7_filename=None, outputname=None):
    if legacymodel is None:
